...
public class ThreadManager {
    ...
    /**
     * 线程池策略：
     * 1.当线程池中的线程小于mCorePoolSize，直接创建新的线程加入线程池执行任务
     * 2.当线程池中的线程数目等于mCorePoolSize，将会把任务放入任务队列BlockingQueue中
     * 3.当BlockingQueue中的任务放满了，将会创建新的线程去执行
     * 4.但是当总线程数大于mMaximumPoolSize时，将会抛出异常，交给RejectedExecutionHandler处理
     */
